    ...
    <form role="form" action=" {{ route('barang.update',$barangs->id) }} " method="POST" enctype="multipart/form-data">
        ...
        <div class="box-body">
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="nama" name="nama_barang" value="{{$barangs->nama_barang }}" required>
            </div>
            <div class="form-group">
                <label for="exampleInputKeterangan">Jumlah</label>
                <input type="number" class="form-control" placeholder="Jumlah" name="jumlah" value="{{ $barangs->jumlah }}" required>
            </div>
            <div class="form-group">
